    ...
    public function run(): void
    {
        ...
        $services = [
            ...
            [
                ...
                'description' => 'Acompanamos a empresas y titulares en procesos de inscripcion, modificacion y actualizacion del Registro de Hidrocarburos. Revisamos la actividad aplicable, ordenamos la documentacion, verificamos requisitos tecnicos y damos seguimiento a observaciones hasta contar con un expediente coherente para la entidad competente.',
                'featured' => true,
                'cover_image' => $gasStationImage,
            ],
            [
            ...
            [
                ...
                'short_description' => 'Preparamos planes de contingencia, analisis de riesgos, medidas de control, protocolos de emergencia, senalizacion y procedimientos operativos.',
                'description' => 'Desarrollamos documentos de gestion de riesgos para actividades de hidrocarburos, incluyendo identificacion de peligros, medidas de control, respuesta ante emergencias, senalizacion, equipos criticos y procedimientos operativos.',
                'featured' => false,
                'cover_image' => $tankerImage,
            ],
            [
