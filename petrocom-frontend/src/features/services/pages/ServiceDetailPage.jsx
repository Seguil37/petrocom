...
const ServiceDetailPage = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#f3f4f6] to-white">
        <div className="flex flex-col items-center gap-4">
          <div className="w-16 h-16 border-4 border-[#1fb74d] border-t-transparent rounded-full animate-spin" />
          <p className="text-[#65647a] font-medium">Cargando servicio...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#f3f4f6] to-white">
        <div className="text-center space-y-4">
          ...
          <p className="text-[#65647a]">Lo sentimos, no pudimos encontrar el servicio que buscas.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-gradient-to-b from-[#f3f4f6] via-white to-[#f3f4f6] min-h-screen pb-16">
      {/* HERO SECTION */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 order-2 lg:order-1">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#1fb74d]/20 border border-[#1fb74d]/40 backdrop-blur">
                  <Zap className="w-4 h-4 text-[#e8a12f]" />
                  <p className="text-sm uppercase tracking-widest text-[#e8a12f] font-bold">{service.category}</p>
                </div>
              ...
              <div className="flex pt-4">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-3 bg-[#1fb74d] text-white font-bold px-8 py-4 rounded-full hover:shadow-lg hover:shadow-[#1fb74d]/40 transition-all duration-300 transform hover:scale-105"
                >
                  Cotizar Servicio
      ...
      <section className="container-custom -mt-8 mb-16 relative z-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white rounded-2xl border-2 border-[#dfe2ea] shadow-lg p-6 hover:shadow-xl transition-shadow">
            <CheckCircle className="w-8 h-8 text-[#1fb74d] mb-3" />
            <p className="text-xs uppercase tracking-widest text-[#65647a] font-bold">Profesional</p>
            <p className="text-lg font-bold text-[#07073b] mt-2">Equipo Experto</p>
          </div>
          <div className="bg-white rounded-2xl border-2 border-[#dfe2ea] shadow-lg p-6 hover:shadow-xl transition-shadow">
            <Zap className="w-8 h-8 text-[#1fb74d] mb-3" />
            <p className="text-xs uppercase tracking-widest text-[#65647a] font-bold">RApido</p>
            <p className="text-lg font-bold text-[#07073b] mt-2">Entrega Agil</p>
          </div>
          <div className="bg-white rounded-2xl border-2 border-[#dfe2ea] shadow-lg p-6 hover:shadow-xl transition-shadow">
            <CheckCircle className="w-8 h-8 text-[#1fb74d] mb-3" />
            <p className="text-xs uppercase tracking-widest text-[#65647a] font-bold">Calidad</p>
            <p className="text-lg font-bold text-[#07073b] mt-2">Garantizado</p>
          </div>
          <div className="bg-white rounded-2xl border-2 border-[#dfe2ea] shadow-lg p-6 hover:shadow-xl transition-shadow">
            <Zap className="w-8 h-8 text-[#1fb74d] mb-3" />
            <p className="text-xs uppercase tracking-widest text-[#65647a] font-bold">Soporte</p>
        ...
        <section className="container-custom mb-16">
          <div className="space-y-8">
            <div className="space-y-3">
              ...
              <p className="text-[#65647a] text-lg font-light">Explora nuestros proyectos y trabajos realizados</p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {service.gallery.map((image, index) => (
                <button
                  ...
                  className="group relative w-full overflow-hidden rounded-2xl border-2 border-[#dfe2ea] shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 focus:outline-none focus:ring-4 focus:ring-[#1fb74d]/50"
                >
                  <img
                    src={toPublicUrl(image.path)}
                    alt={image.caption || service.title}
                    className="w-full aspect-[4/3] object-contain bg-[#f3f4f6] transition-transform duration-500 group-hover:scale-105"
                  />
                  ...
                  <span className="absolute top-4 right-4 text-white text-xs font-bold px-4 py-2 rounded-full bg-[#1fb74d]/90 transform opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                    Ver ampliado +
                  </span>
                </button>
              ))}
      ...
      {lightboxImage && (
        ...
        >
          ...
          >
            <button
              onClick={() => setLightboxImage(null)}
              className="absolute -top-10 right-0 text-white hover:text-[#e8a12f] transition-colors"
              aria-label="Cerrar"
            >
            ...
            <div className="rounded-3xl overflow-hidden bg-black border-2 border-[#1fb74d]/40 shadow-2xl">
              ...
              {lightboxImage.caption && (
                <p className="text-white px-6 py-4 border-t-2 border-[#1fb74d]/30 font-light bg-black/60">
                  {lightboxImage.caption}
                </p>
              )}
            </div>
