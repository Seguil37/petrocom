              ...
              <ol className="space-y-2 text-sm text-[#07073b]">
                ...
                <li className="flex gap-2">
                  ...
                  <button
                    ...
                    className="ml-auto p-1 hover:bg-[#f3f4f6] rounded"
                  >
                    {copied ? (
                      <Check className="w-4 h-4 text-[#07073b]" />
                    ) : (
                      <Copy className="w-4 h-4 text-[#65647a]" />
                    )}
                  </button>
                </li>
                <li className="flex gap-2">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#f3f4f6] rounded-xl p-4 space-y-3">
            <div className="flex justify-between">
              <span className="text-[#65647a]">Monto</span>
              <span className="font-bold text-[#07073b]">S/ {amount.toFixed(2)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#65647a]">Destino</span>
              <span className="font-bold text-[#07073b]">{yapeNumber}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#65647a]">Tu número</span>
              <span className="font-bold text-[#07073b]">+51 {phoneNumber}</span>
            </div>
          </div>

          {/* Nota */}
          <div className="bg-[#f3f4f6] border-l-4 border-[#1fb74d] p-4 rounded">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => setStep(1)}
              className="w-full border-2 border-[#dfe2ea] hover:bg-[#f3f4f6] text-[#07073b] font-semibold py-3 rounded-xl transition-all"
            >
              Volver
            </button>
          </div>
