    ...
    <main className="min-h-screen bg-[#f3f4f6]">
      <section className="border-b border-[#dfe2ea] bg-white">
        <div className="container-custom py-10 lg:py-14">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              <p className="text-sm font-black uppercase text-[#1fb74d]">Seguimiento de tramites</p>
              <h1 className="mt-2 text-3xl font-black text-[#07073b] md:text-4xl">
                Consulta tu tramite con tu codigo
              </h1>
              <p className="mt-3 max-w-xl text-[#65647a]">
              ...
              <div className="mt-5 flex flex-wrap gap-3 text-sm font-semibold text-[#07073b]">
                <span className="rounded-full border border-[#dfe2ea] bg-[#f3f4f6] px-3 py-1">Sin registro</span>
                <span className="rounded-full border border-[#dfe2ea] bg-[#f3f4f6] px-3 py-1">Vista simple</span>
                <span className="rounded-full border border-[#dfe2ea] bg-[#f3f4f6] px-3 py-1">Actualizado por el equipo</span>
              </div>
            </div>

            <form onSubmit={handleSubmit} className="rounded-lg border border-[#dfe2ea] bg-[#ffffff] p-5 shadow-sm">
              ...
              <div className="mt-2 flex flex-col gap-3 sm:flex-row">
                <input
                  ...
                  placeholder=""
                  className="min-h-[48px] flex-1 rounded-lg border border-[#dfe2ea] bg-white px-4 text-[#07073b] outline-none transition focus:border-[#1fb74d]"
                />
                <button
                  type="submit"
                  disabled={loading}
                  className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-lg bg-[#1fb74d] px-5 font-black text-white transition hover:bg-[#168a3d] disabled:cursor-not-allowed disabled:opacity-70"
                >
              ...
              <div className="mt-4 border-t border-[#dfe2ea] pt-4 text-sm text-[#65647a]">
                Los clientes registrados tambien pueden ver todos sus tramites desde{' '}
                <Link to="/cliente/tramites" className="font-black text-[#07073b] hover:text-[#1fb74d]">
                  Mis tramites
                </Link>
                .
              </div>
      ...
      <section className="container-custom py-8">
        {tramite ? (
          ...
          <div className="rounded-lg border border-dashed border-[#dfe2ea] bg-white p-8 text-center">
            <ArrowRight className="mx-auto h-8 w-8 text-[#1fb74d]" />
            <p className="mt-3 text-lg font-black text-[#07073b]">Tu resultado aparecera aqui</p>
            <p className="mt-1 text-sm text-[#65647a]">Usa el codigo exacto entregado por el equipo.</p>
          </div>
        )}
      </section>
    </main>
