      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up">
            ...
            <Link
              to="/register"
              className="group bg-[#F4F5F6] hover:bg-[#F4F5F6] text-[#07073b] font-bold px-8 py-4 rounded-xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1 flex items-center gap-3 min-w-[200px] justify-center border-2 border-[#07073b]"
            >
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              return (
                <div
                  key={index}
                  className="bg-[#F4F5F6]/80 backdrop-blur-sm rounded-xl p-6 shadow-lg animate-fade-in transition-all duration-500 hover:-translate-y-2 hover:bg-white"
