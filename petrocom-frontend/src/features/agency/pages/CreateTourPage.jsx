      ...
      <div className="container-custom max-w-5xl">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#dfe2ea] p-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div>
              <p className="text-sm font-semibold text-[#65647a] uppercase tracking-widest">Nuevo proyecto</p>
              <h1 className="text-3xl font-black text-[#07073b]">Crea un proyecto para el portafolio</h1>
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-[#65647a]">Campo controlado para evitar variaciones como residencial/residencia/vivienda.</p>
              </div>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <textarea
                  ...
                  className="w-full min-h-[140px] rounded-xl border border-[#dfe2ea] px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary resize-y overflow-auto"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full min-h-[180px] rounded-xl border border-[#dfe2ea] px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary resize-y overflow-auto"
            ...
            <section>
              ...
              <div className="flex justify-end mt-4">
                <button
                  type="button"
                  onClick={addImageField}
                  className="inline-flex items-center gap-2 px-5 py-2 rounded-xl border border-[#dfe2ea] text-[#07073b] hover:border-primary"
                >
                  <PlusCircle className="w-4 h-4" /> Anadir imagen
                </button>
              </div>
